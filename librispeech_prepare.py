# Adapted from:
# https://github.com/speechbrain/speechbrain/blob/v0.5.15/recipes/LibriSpeech/librispeech_prepare.py
...
def process_line(wav_file, text_dict) -> LSRow:
    ...
    return LSRow(
        snt_id=snt_id, spk_id=spk_id, duration=duration, file_path=wav_file, words=wrds,
    )
